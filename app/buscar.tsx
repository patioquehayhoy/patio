...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    ...
    spacer: { width: 44 },
    searchBox: { minHeight: 58, borderRadius: 18, borderWidth: 1, borderColor: t.border, backgroundColor: t.surface, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, marginTop: 18 },
    input: { flex: 1, minHeight: 42, paddingHorizontal: 12, fontSize: 18, color: t.text, fontWeight: '400' },
    ...
    emptyIcon: { width: 62, height: 62, borderRadius: 31, borderWidth: 1, borderColor: t.border, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
