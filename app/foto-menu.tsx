...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    ...
    cameraBtnLabel:  { fontSize: 19, fontWeight: '800', color: t.text, letterSpacing: -0.2 },
    ...
    reviewTitle:     { fontSize: 22, fontWeight: '800', color: t.text, letterSpacing: -0.3 },
    reviewSub:       { fontSize: 13, color: t.accent, fontWeight: '700', marginTop: 4 },
    // Section card
    ...
    secName:         { flex: 1, fontSize: 12, fontWeight: '700', letterSpacing: 0.4, color: t.text, textTransform: 'uppercase', paddingVertical: 0 },
    ...
    savedTitle:      { fontSize: 22, fontWeight: '800', color: t.text, letterSpacing: -0.3 },
