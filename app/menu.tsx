...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    ...
    secName:         { flex: 1, marginRight: 12, fontSize: 12, fontWeight: '900', color: t.text, textTransform: 'uppercase', paddingVertical: 0, lineHeight: 16 },
    priceWrap:       { marginLeft: 'auto', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'flex-end', paddingBottom: 1 },
    pricePrefix:     { fontSize: 13, fontWeight: '900', color: t.textSecondary, marginRight: 0 },
    secPrecio:       { minWidth: 10, fontSize: 13, fontWeight: '300', color: t.textSecondary, textAlign: 'left', paddingVertical: 0, paddingHorizontal: 0, backgroundColor: 'transparent' },
    ...
    platName:        { flex: 1, fontSize: 17, fontWeight: '900', color: t.text, paddingVertical: 0, lineHeight: 23 },
    platDesc:        { marginTop: 3, fontSize: 15, color: t.textSecondary, paddingVertical: 0, lineHeight: 21 },
    pricePrefixMuted:{ fontSize: 13, fontWeight: '300', color: t.textSecondary, marginRight: 0 },
    platPrecio:      { minWidth: 26, fontSize: 13, fontWeight: '300', color: t.textSecondary, textAlign: 'left', paddingVertical: 0, paddingHorizontal: 0, backgroundColor: 'transparent' },
    ...
    emptyStatePhotoLabel: { marginTop: 10, fontSize: 15, fontWeight: '900', color: t.text },
    ...
    emptyStateSecondaryBtnText: { fontSize: 14, fontWeight: '300', color: t.text },
    ...
    templateLinkText: { fontSize: 13, fontWeight: '300', color: t.textSecondary },
    // Secondary actions
    ...
    optionsToggleText: { fontSize: 13, fontWeight: '300', color: t.textSecondary },
    ...
    actionSheetItemText: { fontSize: 16, fontWeight: '900', color: t.text },
    actionSheetDeleteText: { fontSize: 16, fontWeight: '900', color: '#C65A45' },
    ...
    actionSheetCancelText: { fontSize: 16, fontWeight: '900', color: t.text },
    // Modal
    ...
    presetTitle:     { fontSize: 18, fontWeight: '900', color: t.text },
    ...
    templatePillText: { fontSize: 12, fontWeight: '900', color: t.textSecondary },
    templatePillTextSelected: { color: '#fff' },
    presetCaption:   { marginBottom: 10, fontSize: 12, fontWeight: '300', color: t.textSecondary },
    ...
    checkDotMark:    { color: '#fff', fontSize: 12, fontWeight: '900', lineHeight: 12 },
    checkLabel:      { fontSize: 15, fontWeight: '300', color: t.text },
    ...
    btnTertiaryText: { fontSize: 14, fontWeight: '900', color: t.text },
    ...
    btnSecondaryText:{ color: t.textSecondary, fontSize: 14, fontWeight: '300' },
  });
}
