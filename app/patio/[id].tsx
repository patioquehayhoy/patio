...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    ...
    eyebrow: { fontSize: 12, fontWeight: '900', color: t.textSecondary, marginBottom: 8 },
    ...
    menuSectionTitle: { fontSize: 13, fontWeight: '900', color: t.textSecondary },
    ...
    sectionTitle: { fontSize: 12, fontWeight: '900', color: t.text, marginBottom: 12 },
