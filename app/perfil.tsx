...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    ...
    block:          { paddingTop: 26 },
    blockLabel:     { fontSize: 12, fontWeight: '800', color: t.text, letterSpacing: 0.3, marginBottom: 10 },
    saveInlineBtn:  { fontSize: 16, fontWeight: '900', color: t.accent, paddingTop: 2 },
    nombreInput:    { fontSize: 34, fontWeight: '900', color: t.text, letterSpacing: 0, lineHeight: 40, paddingVertical: 0, paddingHorizontal: 0, backgroundColor: 'transparent', marginBottom: 8 },
    ...
    categoryWheelText: { fontSize: 18, fontWeight: '700', color: t.textSecondary, opacity: 0.5 },
    categoryWheelTextActive: { color: t.text, fontSize: 20, opacity: 1 },
